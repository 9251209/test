...
import com.goyo.project.model.Users;
...
//		return (UserInfo) requestAttributes.getAttribute("sessionUserInfo",RequestAttributes.SCOPE_SESSION);
        return (Users) requestAttributes.getAttribute("sessionUserInfo", RequestAttributes.SCOPE_SESSION);
    }
...
//        HttpServletResponse response = ((ServletRequestAttributes)requestAttributes).getResponse();
    ...
    public static void setCurrentUserInfo(Users userInfo) {
        RequestAttributes requestAttributes = RequestContextHolder.currentRequestAttributes();
